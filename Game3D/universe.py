...
def load_json(path):
    # If path is already absolute or relative to GAME_DIR, use it directly
...
class Universe:
    def __init__(self):
        self.rom_db = load_json("data/rom_database.json")
        self.galaxies = []
        self.zones = []
        self.companions = []
        self.ai_companion = {}
    ...
    def load_universe(self):
        gal_dir = os.path.join(DATA_DIR, "galaxies")
        ...
        comp_dir = os.path.join(DATA_DIR, "pokemon_companions")
        ...
        ai_path = os.path.join(DATA_DIR, "ai_companion", "ai_companion.json")
